...
open class BaseApiGatewayContext(protected val context: IacContext) : ApiGatewayEnabled by context {
    ...
    open fun createApiKey(name: String, init: CreateApiKeyRequest.() -> Unit): CreateApiKeyResult {
    ...
    open fun createAuthorizer(name: String, init: CreateAuthorizerRequest.() -> Unit): CreateAuthorizerResult {
    ...
    open fun createModel(name: String, init: CreateModelRequest.() -> Unit): CreateModelResult {
    ...
    open fun createRestApi(name: String, init: CreateRestApiRequest.() -> Unit): CreateRestApiResult {
    ...
    open fun createStage(stageName: String, init: CreateStageRequest.() -> Unit): CreateStageResult {
    ...
    open fun createUsagePlan(name: String, init: CreateUsagePlanRequest.() -> Unit): CreateUsagePlanResult {
